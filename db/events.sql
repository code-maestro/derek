...
delimiter |
-- FEEDS RESTOCK ALERT
CREATE EVENT IF NOT EXISTS feeds_tracker
...
-- NEW BORN ALERT
CREATE EVENT IF NOT EXISTS vaccinations_tracker

    ON SCHEDULE

        EVERY 1 DAY

    COMMENT 'PENDING VACCINATIONS EVENT'
...
-- NEW BORN ALERT
CREATE EVENT IF NOT EXISTS test_test
