...
app.get('/test', function (request, response) {
    // Render login template
    response.sendFile(path.join(__dirname + '/last.html'));
});
...
// tests
app.get('/tss', function (request, response) {
                                    ...
                                    <div class="col-xl-3 col-md-6 mb-4">
                                        <div class="card border-left-primary shadow h-100 py-2">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Total Number of Animals </div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"> 40 </div>
                                                    </div>
                                                    <div class="col-auto">
                                                        <i class="fa-solid fa-baby-carriage fa-2x"></i>
...
// New Animal Modal
app.get('/nim', function (request, response) {

    response.send(nimals);
    // response.append('Set-Cookie', 'LandingPage=' + nimals);
